"""
Django settings for dk_management project.
...
SECRET_KEY = 'django-insecure-4%rir_2kz&$wsc$vr2admx29352mhuw1&l5rsz!=h!w4@#opao'
...
WSGI_APPLICATION = 'dk_management.wsgi.application'
